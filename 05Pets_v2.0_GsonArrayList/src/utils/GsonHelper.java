...
public class GsonHelper {
	...
	/** Adicione las clases que sea necesario */
	 ...
	 @Deprecated
	public static String listaMascotasToJson(ListaMascota list){
		GsonBuilder builder = new GsonBuilder(); 
		builder.registerTypeAdapter(Mascota.class,new  MascotaSerializer()); 
		Gson gson = builder.create(); 
		String strList = gson.toJson(list, ListaMascota.class);	
		return strList;
	} 
	 ...
	 */
	 ...
	 @Deprecated
	public static ListaMascota jsonFromlistaMascotasToJson(String strJson){  
		GsonBuilder builder = new GsonBuilder(); 
		builder.registerTypeAdapter(Mascota.class,new MascotaDeserializer()); 
		Gson gson = builder.create(); 
		ListaMascota list = gson.fromJson(strJson,ListaMascota.class); 
		return list;
	}
